...
research_content = File.read(Rails.root.join("db", "seeds", "research_content.md"))
...
puts "Creating research content_block"
ContentBlock.find_or_create_by(key: "research", content: research_content)
