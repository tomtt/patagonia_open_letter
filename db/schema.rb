...
ActiveRecord::Schema[7.1].define(version: 2024_04_09_122057) do
  ...
  create_table "letter_translations", force: :cascade do |t|
  ...
  create_table "signatories", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "position"
    t.index ["name"], name: "index_signatories_on_name", unique: true
  end
  ...
  create_table "supporting_organisations", force: :cascade do |t|
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "url"
    t.integer "position"
    t.integer "image_max_height"
    t.index ["name"], name: "index_supporting_organisations_on_name", unique: true
  end
